...
class SessionManager {
    constructor() {
        ...
        this.sessionsDir = null; // Будет устанавливаться для каждого пользователя
    }
    ...
    async setUserSessionsDir(userSessionsDir) {
        ...
        console.log(`Устанавливаем папку сессий: ${userSessionsDir}`);
        ...
        console.log(`Загружено ${this.sessions.size} сессий для пользователя`);
    }
